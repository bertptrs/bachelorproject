...
Due to time constraints, it was not possible to create a program that could materialize the \forelem implementation of Push-Lift (see appendix \ref{app:pushlift}) into a compilable or runnable algorithm, as described in. %TODO reference
